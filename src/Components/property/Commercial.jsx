  ...
  return (
    ...
    <div className="container">
      ...
      <div className="flex justify-start items-center gap-10 bg-[#C8F0E2] p-5 ">
        ...
        <button onClick={()=>handleData('apartment')} className='text-md font-roboto font-medium'>USA</button>
        <button onClick={()=>handleData('duplex')} className='text-md font-roboto font-medium'>UK</button>
        <button onClick={()=>handleData('building')} className='text-md font-roboto font-medium'>Bangladesh</button>
        <button onClick={()=>handleData('penthouse')} className='text-md font-roboto font-medium'>Canada</button>
        <button onClick={()=>handleData('luxury')} className='text-md font-roboto font-medium'>Nigeria</button>
      </div>
