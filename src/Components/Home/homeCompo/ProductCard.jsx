...
const ProductCard = () => {
  ...
  const handleCart =(items)=>{
    ...
    set(push(ref(db, 'cart/')), {
      productId : cartSlice.id,
      productDetails : cartSlice.brief,
      productPrice : cartSlice.price,
      productImage : cartSlice.image,
    });
          ...
          <div key={item.id} className="bg-white shadow-md rounded-lg w-80 border border-gray-200 overflow-hidden">
           ...
           <div className="relative">
             <img
               ...
               />
             <div onClick={()=>handleCart(item)} className="absolute top-2 right-2 bg-white p-2 rounded-full shadow-lg hover:bg-gray-100">
               <TiShoppingCart   className="text-green-500 text-xl" />
             </div>
